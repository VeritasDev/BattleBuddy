...
class AmmoSortConfig: SortConfiguration {
    ...
    func updateSort() {
        ammo.sort {
            ...
            case (true, AmmoSortableParam.damage.rawValue): return $0.totalDamage < $1.totalDamage
            case (false, AmmoSortableParam.damage.rawValue): return $0.totalDamage > $1.totalDamage
            default: fatalError()
            }
        }
    }
